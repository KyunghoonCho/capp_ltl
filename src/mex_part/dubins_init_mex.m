function [path_qi,path_rho,path_param,path_type,errorout] = dubins_init_mex(q0,q1,rho)
...
if( rho<0 )
    ...
    [path_param,path_type,errorout] = dubins_init_normalised(alpha,beta,d);
end
end
...
function [path_param,path_type,errorout] = dubins_init_normalised(alpha,beta,d)
best_cost = inf;
best_word = -1;
